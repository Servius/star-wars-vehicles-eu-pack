...
ENT.EntModel = "models/bsp_strike/bsp_strike.mdl"
ENT.Vehicle = "bsp_strike"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("bsp_strike");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_strike")
		local Flying = p:GetNWBool("Flyingbsp_strike");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_strikeView", CalcView)
	...
	hook.Add("HUDPaint", "bsp_strikeReticle", bsp_strikeReticle)
