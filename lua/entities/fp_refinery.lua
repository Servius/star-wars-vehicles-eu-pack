...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fp_refinery")
		local Flying = p:GetNWBool("Flyingfp_refinery");
		local pos,face;
	...
	hook.Add("CalcView", "fp_refineryView", CalcView)
	...
	hook.Add("HUDPaint", "fp_refineryReticle", fp_refineryReticle)
