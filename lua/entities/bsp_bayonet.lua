...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_bayonet")
		local Flying = p:GetNWBool("Flyingbsp_bayonet");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_bayonetView", CalcView)
	...
	hook.Add("HUDPaint", "bsp_bayonetReticle", bsp_bayonetReticle)
