...
ENT.EntModel = "models/fp_mc40/fp_mc40.mdl"
ENT.Vehicle = "fp_mc40"
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fp_mc40")
		local Flying = p:GetNWBool("Flyingfp_mc40");
		local pos,face;
	...
	hook.Add("CalcView", "fp_mc40View", CalcView)
	...
	hook.Add("HUDPaint", "fp_mc40Reticle", fp_mc40Reticle)
