...
ENT.PrintName = "bsp_interdictorsd"
...
ENT.EntModel = "models/bsp_interdictorsd/bsp_interdictorsd.mdl"
ENT.Vehicle = "bsp_interdictorsd"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("bsp_interdictorsd");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_interdictorsd")
		local Flying = p:GetNWBool("Flyingbsp_interdictorsd");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_interdictorsdView", CalcView)
	...
	function bsp_interdictorsdReticle()
	...
	hook.Add("HUDPaint", "bsp_interdictorsdReticle", bsp_interdictorsdReticle)
