...
ENT.PrintName = "csp_geodreadnauhgt"
...
ENT.EntModel = "models/csp_geodread/csp_geodread.mdl"
ENT.Vehicle = "csp_geodreadnauhgt"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("csp_geodreadnauhgt");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("csp_geodreadnauhgt")
		local Flying = p:GetNWBool("Flyingcsp_geodreadnauhgt");
		local pos,face;
	...
	hook.Add("CalcView", "csp_geodreadnauhgtView", CalcView)
	...
	function csp_geodreadnauhgtReticle()
	...
	hook.Add("HUDPaint", "csp_geodreadnauhgtReticle", csp_geodreadnauhgtReticle)
