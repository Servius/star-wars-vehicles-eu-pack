...
ENT.EntModel = "models/fp_gr75/fp_gr75.mdl"
ENT.Vehicle = "fp_gr75"
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fp_gr75")
		local Flying = p:GetNWBool("Flyingfp_gr75");
		local pos,face;
	...
	hook.Add("CalcView", "fp_gr75View", CalcView)
	...
	hook.Add("HUDPaint", "fp_gr75Reticle", fp_gr75Reticle)
