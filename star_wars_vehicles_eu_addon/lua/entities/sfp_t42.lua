...
ENT.EntModel = "models/sfp_t42/sfp_t42.mdl" --The oath to the model you want to use.
ENT.Vehicle = "sfp_t42" --The internal name for the ship. It cannot be the same as a different ship.
...
function ENT:SpawnFunction(pl, tr)
    local e = ents.Create("sfp_t42"); -- This should be the same name as the file
...
function ENT:Initialize()
	...
	self.ExitModifier = {x=25,y=50,z=150}
...
function ENT:Effects()
    ...
    hook.Add("CalcView", "sfp_t42view", CalcView) -- This is very important. Make sure the middle arguement is unique. In this case the ship name + view
 
	local function sfp_t42Reticle()
		
		local p = LocalPlayer();
		local Flying = p:GetNWBool("Flyingsfp_t42");
		local self = p:GetNWEntity("sfp_t42");
    ...
    hook.Add("HUDPaint", "sfp_t42Reticle", sfp_t42Reticle) -- Here you need to make the middle argument something unique again. I've set it as what the function is called. Could be anything. And the final arguement should be the function just made.
