...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("fp_tonfalk");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fp_tonfalk")
		local Flying = p:GetNWBool("Flyingfp_tonfalk");
		local pos,face;
	...
	hook.Add("HUDPaint", "fp_tonfalkReticle", fp_tonfalkReticle)
