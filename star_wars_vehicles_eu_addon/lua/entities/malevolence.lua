...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("malevolence");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("malevolence")
		local Flying = p:GetNWBool("Flyingmalevolence");
		local pos,face;
	...
	hook.Add("CalcView", "malevolenceView", CalcView)
	...
	hook.Add("HUDPaint", "malevolenceReticle", malevolenceReticle)
