...
ENT.EntModel = "models/csp_sovereign/csp_sovereign.mdl"
ENT.Vehicle = "csp_sovereign"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("csp_sovereign");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("csp_sovereign")
		local Flying = p:GetNWBool("Flyingcsp_sovereign");
		local pos,face;
	...
	hook.Add("CalcView", "csp_sovereignView", CalcView)
	...
	hook.Add("HUDPaint", "csp_sovereignReticle", csp_sovereignReticle)
