...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("fp_assault");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fp_assault")
		local Flying = p:GetNWBool("Flyingfp_assault");
		local pos,face;
	...
	hook.Add("CalcView", "fp_assaultView", CalcView)
	...
	hook.Add("HUDPaint", "fp_assaultReticle", fp_assaultReticle)
