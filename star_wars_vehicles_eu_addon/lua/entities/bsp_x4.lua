...
ENT.EntModel = "models/bsp_x4/bsp_x4.mdl"
ENT.Vehicle = "bsp_x4"
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_x4")
		local Flying = p:GetNWBool("Flyingbsp_x4");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_x4View", CalcView)
	...
	hook.Add("HUDPaint", "bsp_x4Reticle", bsp_x4Reticle)
