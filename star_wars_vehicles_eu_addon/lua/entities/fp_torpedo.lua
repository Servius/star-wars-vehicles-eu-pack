...
ENT.EntModel = "models/fp_torpedo/fp_torpedo.mdl"
ENT.Vehicle = "fp_torpedo"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("fp_torpedo");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fp_torpedo")
		local Flying = p:GetNWBool("Flyingfp_torpedo");
		local pos,face;
	...
	hook.Add("CalcView", "fp_torpedoView", CalcView)
	...
	hook.Add("HUDPaint", "fp_torpedoReticle", fp_torpedoReticle)
