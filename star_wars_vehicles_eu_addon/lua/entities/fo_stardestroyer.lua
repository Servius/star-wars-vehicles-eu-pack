...
ENT.EntModel = "models/sweaw/ships/fo_stardestroyer.mdl"
ENT.Vehicle = "fo_stardestroyer"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("fo_stardestroyer");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fo_stardestroyer")
		local Flying = p:GetNWBool("Flyingfo_stardestroyer");
		local pos,face;
	...
	hook.Add("CalcView", "fo_stardestroyerView", CalcView)
	...
	function fo_stardestroyerReticle()
	...
	hook.Add("HUDPaint", "fo_stardestroyerReticle", fo_stardestroyerReticle)
