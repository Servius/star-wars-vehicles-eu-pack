...
ENT.EntModel = "models/bsp_crusader/bsp_crusader.mdl"
ENT.Vehicle = "bsp_crusader"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("bsp_crusader");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_crusader")
		local Flying = p:GetNWBool("Flyingbsp_crusader");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_crusaderView", CalcView)
	...
	hook.Add("HUDPaint", "bsp_crusaderReticle", bsp_crusaderReticle)
