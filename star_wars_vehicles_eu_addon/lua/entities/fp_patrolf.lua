...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fp_patrolf")
		local Flying = p:GetNWBool("Flyingfp_patrolf");
		local pos,face;
	...
	hook.Add("CalcView", "fp_patrolfView", CalcView)
	...
	hook.Add("HUDPaint", "fp_patrolfReticle", fp_patrolfReticle)
