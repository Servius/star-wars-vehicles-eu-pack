...
ENT.EntModel = "models/bsp_isc/bsp_isc.mdl"
ENT.Vehicle = "bsp_isc"
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_isc")
		local Flying = p:GetNWBool("Flyingbsp_isc");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_iscView", CalcView)
	...
	hook.Add("HUDPaint", "bsp_iscReticle", bsp_iscReticle)
