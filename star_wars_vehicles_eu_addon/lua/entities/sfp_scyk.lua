...
function ENT:Initialize()
	...
	self.ExitModifier = {x=25,y=225,z=10}
    ...
    self.Bullet = CreateBulletStructure(50,"yellow",false); -- The first number is bullet damage, the second colour. green and red are the only options. (Set to blue for ion shot, the damage will be halved but ships will be disabled after consecutive hits). The final one is for splash damage. Set to true if you don't want splashdamage.
