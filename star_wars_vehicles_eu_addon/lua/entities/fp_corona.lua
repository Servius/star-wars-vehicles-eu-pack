...
ENT.EntModel = "models/fp_corona/fp_corona.mdl"
ENT.Vehicle = "fp_corona"
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fp_corona")
		local Flying = p:GetNWBool("Flyingfp_corona");
		local pos,face;
	...
	hook.Add("CalcView", "fp_coronaView", CalcView)
	...
	hook.Add("HUDPaint", "fp_coronaReticle", fp_coronaReticle)
