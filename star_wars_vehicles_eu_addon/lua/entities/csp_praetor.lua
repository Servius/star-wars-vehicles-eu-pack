...
ENT.EntModel = "models/csp_praetor/csp_praetor.mdl"
ENT.Vehicle = "csp_praetor"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("csp_praetor");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("csp_praetor")
		local Flying = p:GetNWBool("Flyingcsp_praetor");
		local pos,face;
	...
	hook.Add("CalcView", "csp_praetorView", CalcView)
	...
	hook.Add("HUDPaint", "csp_praetorReticle", csp_praetorReticle)
