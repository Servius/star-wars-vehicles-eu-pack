...
function ENT:SpawnFunction(pl, tr)
    local e = ents.Create("sfp_viper"); -- This should be the same name as the file
...
function ENT:Initialize()
	...
	self.ExitModifier = {x=100,y=175,z=100}
...
function ENT:Effects()
    ...
    local function CalcView()      
		...
		local p = LocalPlayer();
		local self = p:GetNetworkedEntity("sfp_viper", NULL)
    ...
    hook.Add("CalcView", "sfp_viperview", CalcView) -- This is very important. Make sure the middle arguement is unique. In this case the ship name + view
 
	local function sfp_viperReticle()
    ...
    hook.Add("HUDPaint", "sfp_viperReticle", sfp_viperReticle) -- Here you need to make the middle argument something unique again. I've set it as what the function is called. Could be anything. And the final arguement should be the function just made.
