...
ENT.EntModel = "models/csp_secutor/csp_secutor.mdl"
ENT.Vehicle = "csp_secutor"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("csp_secutor");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("csp_secutor")
		local Flying = p:GetNWBool("Flyingcsp_secutor");
		local pos,face;
	...
	hook.Add("CalcView", "csp_secutorView", CalcView)
	...
	hook.Add("HUDPaint", "csp_secutorReticle", csp_secutorReticle)
