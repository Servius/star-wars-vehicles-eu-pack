...
ENT.EntModel = "models/bsp_mcruiser/bsp_mcruiser.mdl"
ENT.Vehicle = "bsp_mcruiser"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("bsp_mcruiser");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_mcruiser")
		local Flying = p:GetNWBool("Flyingbsp_mcruiser");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_mcruiserView", CalcView)
	...
	hook.Add("HUDPaint", "bsp_mcruiserReticle", bsp_mcruiserReticle)
