...
ENT.EntModel = "models/csp_bothan/csp_bothan.mdl"
ENT.Vehicle = "csp_bothan"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("csp_bothan");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("csp_bothan")
		local Flying = p:GetNWBool("Flyingcsp_bothan");
		local pos,face;
	...
	hook.Add("CalcView", "csp_bothanView", CalcView)
	...
	hook.Add("HUDPaint", "csp_bothanReticle", csp_bothanReticle)
