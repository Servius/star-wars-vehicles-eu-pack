...
ENT.EntModel = "models/sweaw/ships/fo_resurgent.mdl"
ENT.Vehicle = "fo_resurgent"
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fo_resurgent")
		local Flying = p:GetNWBool("Flyingfo_resurgent");
		local pos,face;
	...
	hook.Add("CalcView", "fo_resurgentView", CalcView)
	...
	hook.Add("HUDPaint", "fo_resurgentReticle", fo_resurgentReticle)
