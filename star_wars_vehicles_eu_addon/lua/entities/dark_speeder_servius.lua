...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("dark_speeder_servius");
...
if CLIENT then
	...
	function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("dark_speeder_servius", NULL)
	...
	hook.Add("CalcView", "dark_speeder_serviusView", CalcView)

	
	hook.Add( "ShouldDrawLocalPlayer", "dark_speeder_serviusDrawPlayerModel", function( p )
		local self = p:GetNWEntity("dark_speeder_servius", NULL);
		local DriverSeat = p:GetNWEntity("DriverSeat",NULL);
		local PassengerSeat = p:GetNWEntity("PassengerSeat",NULL);
		if(IsValid(self)) then
	...
	function dark_speeder_serviusReticle()
	
		local p = LocalPlayer();
		local Flying = p:GetNWBool("Flyingdark_speeder_servius");
		local self = p:GetNWEntity("dark_speeder_servius");
	...
	hook.Add("HUDPaint", "dark_speeder_serviusReticle", dark_speeder_serviusReticle)
