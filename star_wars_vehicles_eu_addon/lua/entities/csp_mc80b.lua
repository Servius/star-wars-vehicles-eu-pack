...
ENT.EntModel = "models/csp_mc80b/csp_mc80b.mdl"
ENT.Vehicle = "csp_mc80b"
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("csp_mc80b")
		local Flying = p:GetNWBool("Flyingcsp_mc80b");
		local pos,face;
	...
	hook.Add("CalcView", "csp_mc80bView", CalcView)
	...
	hook.Add("HUDPaint", "csp_mc80bReticle", csp_mc80bReticle)
