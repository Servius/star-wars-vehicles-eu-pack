...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("speeder_servius_4");
...
if CLIENT then
	...
	function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("speeder_servius_4", NULL)
	...
	hook.Add("CalcView", "speeder_servius_4View", CalcView)

	
	hook.Add( "ShouldDrawLocalPlayer", "speeder_servius_4DrawPlayerModel", function( p )
		local self = p:GetNWEntity("speeder_servius_4", NULL);
		local DriverSeat = p:GetNWEntity("DriverSeat",NULL);
		local PassengerSeat = p:GetNWEntity("PassengerSeat",NULL);
		if(IsValid(self)) then
	...
	function speeder_servius_4Reticle()
	
		local p = LocalPlayer();
		local Flying = p:GetNWBool("Flyingspeeder_servius_4");
		local self = p:GetNWEntity("speeder_servius_4");
	...
	hook.Add("HUDPaint", "speeder_servius_4Reticle", speeder_servius_4Reticle)
