...
ENT.EntModel = "models/bsp_faragut/bsp_faragut.mdl"
ENT.Vehicle = "bsp_faragut"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("bsp_faragut");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_faragut")
		local Flying = p:GetNWBool("Flyingbsp_faragut");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_faragutView", CalcView)
	...
	hook.Add("HUDPaint", "bsp_faragutReticle", bsp_faragutReticle)
