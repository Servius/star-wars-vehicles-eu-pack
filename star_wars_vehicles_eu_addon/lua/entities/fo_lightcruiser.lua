...
ENT.EntModel = "models/sweaw/ships/fo_lightcruiser.mdl"
ENT.Vehicle = "fo_lightcruiser"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("fo_lightcruiser");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fo_lightcruiser")
		local Flying = p:GetNWBool("Flyingfo_lightcruiser");
		local pos,face;
	...
	hook.Add("CalcView", "fo_lightcruiserView", CalcView)
	...
	function fo_lightcruiserReticle()
	...
	hook.Add("HUDPaint", "fo_lightcruiserReticle", fo_lightcruiserReticle)
