...
ENT.EntModel = "models/bsp_bellator/bsp_bellator.mdl"
ENT.Vehicle = "bsp_bellator"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("bsp_bellator");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_bellator")
		local Flying = p:GetNWBool("Flyingbsp_bellator");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_bellatorView", CalcView)
	...
	hook.Add("HUDPaint", "bsp_bellatorReticle", bsp_bellatorReticle)
