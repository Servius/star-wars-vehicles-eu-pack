...
ENT.EntModel = "models/bsp_eclipse1/bsp_eclipse1.mdl"
ENT.Vehicle = "bsp_eclipse1"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("bsp_eclipse1");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_eclipse1")
		local Flying = p:GetNWBool("Flyingbsp_eclipse1");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_eclipse1View", CalcView)
	...
	hook.Add("HUDPaint", "bsp_eclipse1Reticle", bsp_eclipse1Reticle)
