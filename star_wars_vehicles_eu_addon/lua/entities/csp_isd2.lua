...
ENT.EntModel = "models/csp_isd2/csp_isd2.mdl"
ENT.Vehicle = "csp_isd2"
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("csp_isd2")
		local Flying = p:GetNWBool("Flyingcsp_isd2");
		local pos,face;
	...
	hook.Add("CalcView", "csp_isd2View", CalcView)
	...
	hook.Add("HUDPaint", "csp_isd2Reticle", csp_isd2Reticle)
