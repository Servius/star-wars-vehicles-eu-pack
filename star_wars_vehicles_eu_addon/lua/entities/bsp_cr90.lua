...
ENT.EntModel = "models/bsp_cr90/bsp_cr90.mdl"
ENT.Vehicle = "bsp_cr90"
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_cr90")
		local Flying = p:GetNWBool("Flyingbsp_cr90");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_cr90View", CalcView)
	...
	hook.Add("HUDPaint", "bsp_cr90Reticle", bsp_cr90Reticle)
