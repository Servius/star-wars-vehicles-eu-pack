...
ENT.EntModel = "models/sweaw/ships/rep_advanced x-wing.mdl" //The oath to the model you want to use.
ENT.Vehicle = "advanced_xwing" //The internal name for the ship. It cannot be the same as a different ship.
...
function ENT:SpawnFunction(pl, tr)
    local e = ents.Create("advanced_xwing"); // This should be the same name as the file
...
function ENT:Effects()
    ...
    local function CalcView()      
		...
		local p = LocalPlayer();
		local self = p:GetNetworkedEntity("advanced_xwing", NULL)
    ...
    hook.Add("CalcView", "advanced_xwingview", CalcView) // This is very important. Make sure the middle arguement is unique. In this case the ship name + view
 
	local function advanced_xwingReticle()
		
		local p = LocalPlayer();
		local Flying = p:GetNWBool("Flyingadvanced_xwing");
		local self = p:GetNWEntity("advanced_xwing");
    ...
    hook.Add("HUDPaint", "advanced_xwingReticle", advanced_xwingReticle) // Here you need to make the middle argument something unique again. I've set it as what the function is called. Could be anything. And the final arguement should be the function just made.
