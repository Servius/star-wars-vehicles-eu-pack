...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_marauder")
		local Flying = p:GetNWBool("Flyingbsp_marauder");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_marauderView", CalcView)
	...
	hook.Add("HUDPaint", "bsp_marauderReticle", bsp_marauderReticle)
