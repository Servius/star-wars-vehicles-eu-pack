...
ENT.EntModel = "models/fp_battledragon/fp_battledragon.mdl"
ENT.Vehicle = "fp_battledragon"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("fp_battledragon");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fp_battledragon")
		local Flying = p:GetNWBool("Flyingfp_battledragon");
		local pos,face;
	...
	hook.Add("CalcView", "fp_battledragonView", CalcView)
	...
	function fp_battledragonReticle()
	...
	hook.Add("HUDPaint", "fp_battledragonReticle", fp_battledragonReticle)
