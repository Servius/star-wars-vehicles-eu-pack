...
ENT.EntModel = "models/csp_mcheavy/csp_mcheavy.mdl"
ENT.Vehicle = "csp_mcheavy"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("csp_mcheavy");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("csp_mcheavy")
		local Flying = p:GetNWBool("Flyingcsp_mcheavy");
		local pos,face;
	...
	hook.Add("CalcView", "csp_mcheavyView", CalcView)
	...
	hook.Add("HUDPaint", "csp_mcheavyReticle", csp_mcheavyReticle)
