...
ENT.EntModel = "models/sweaw/ships/fo_mandatoriv.mdl"
ENT.Vehicle = "fo_mandator"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("fo_mandator");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fo_mandator")
		local Flying = p:GetNWBool("Flyingfo_mandator");
		local pos,face;
	...
	hook.Add("CalcView", "fo_mandatorView", CalcView)
	...
	hook.Add("HUDPaint", "fo_mandatorReticle", fo_mandatorReticle)
