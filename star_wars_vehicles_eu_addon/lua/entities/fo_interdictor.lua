...
ENT.EntModel = "models/sweaw/ships/fo_interdictor.mdl"
ENT.Vehicle = "fo_interdictor"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("fo_interdictor");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fo_interdictor")
		local Flying = p:GetNWBool("Flyingfo_interdictor");
		local pos,face;
	...
	hook.Add("CalcView", "fo_interdictorView", CalcView)
	...
	function fo_interdictorReticle()
	...
	hook.Add("HUDPaint", "fo_interdictorReticle", fo_interdictorReticle)
