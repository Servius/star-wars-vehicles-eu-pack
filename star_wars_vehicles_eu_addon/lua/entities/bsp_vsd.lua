...
ENT.EntModel = "models/bsp_vsd/bsp_vsd.mdl"
ENT.Vehicle = "bsp_vsd"
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_vsd")
		local Flying = p:GetNWBool("Flyingbsp_vsd");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_vsdView", CalcView)
	...
	hook.Add("HUDPaint", "bsp_vsdReticle", bsp_vsdReticle)
