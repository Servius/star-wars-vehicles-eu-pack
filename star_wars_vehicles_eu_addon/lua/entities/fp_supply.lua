...
ENT.EntModel = "models/fp_supply/fp_supply.mdl"
ENT.Vehicle = "fp_supply"
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fp_supply")
		local Flying = p:GetNWBool("Flyingfp_supply");
		local pos,face;
	...
	hook.Add("CalcView", "fp_supplyView", CalcView)
	...
	hook.Add("HUDPaint", "fp_supplyReticle", fp_supplyReticle)
