...
ENT.EntModel = "models/csp_allegiance/csp_allegiance.mdl"
ENT.Vehicle = "allegiance"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("allegiance");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("allegiance")
		local Flying = p:GetNWBool("Flyingallegiance");
		local pos,face;
	...
	hook.Add("CalcView", "allegianceView", CalcView)
	...
	hook.Add("HUDPaint", "allegianceReticle", allegianceReticle)
