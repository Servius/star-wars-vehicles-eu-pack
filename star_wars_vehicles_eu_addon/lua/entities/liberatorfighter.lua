...
ENT.PrintName = "Liberator Fighter";
...
function ENT:SpawnFunction(pl, tr)
    local e = ents.Create("liberatorfighter"); // This should be the same name as the file
...
function ENT:Effects()
    ...
    local function CalcView()      
		...
		local p = LocalPlayer();
		local self = p:GetNetworkedEntity("LiberatorFighter", NULL)
    ...
    hook.Add("CalcView", "LiberatorFighterview", CalcView) // This is very important. Make sure the middle arguement is unique. In this case the ship name + view
 
	local function LiberatorFighterReticle()
		
		local p = LocalPlayer();
		local Flying = p:GetNWBool("FlyingLiberatorFighter");
		local self = p:GetNWEntity("LiberatorFighter");
    ...
    hook.Add("HUDPaint", "LiberatorFighterReticle", LiberatorFighterReticle) // Here you need to make the middle argument something unique again. I've set it as what the function is called. Could be anything. And the final arguement should be the function just made.
