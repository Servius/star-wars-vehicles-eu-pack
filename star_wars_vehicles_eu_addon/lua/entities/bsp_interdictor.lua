...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("bsp_interdictor");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_interdictor")
		local Flying = p:GetNWBool("Flyingbsp_interdictor");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_interdictorView", CalcView)
	...
	function bsp_interdictorReticle()
	...
	hook.Add("HUDPaint", "bsp_interdictorReticle", bsp_interdictorReticle)
