...
ENT.EntModel = "models/csp_legacy/csp_legacy.mdl"
ENT.Vehicle = "csp_legacy"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("csp_legacy");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("csp_legacy")
		local Flying = p:GetNWBool("Flyingcsp_legacy");
		local pos,face;
	...
	hook.Add("CalcView", "csp_legacyView", CalcView)
	...
	hook.Add("HUDPaint", "csp_legacyReticle", csp_legacyReticle)
