...
ENT.EntModel = "models/fp_stalwart/fp_stalwart.mdl"
ENT.Vehicle = "fp_stalwart"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("fp_stalwart");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fp_stalwart")
		local Flying = p:GetNWBool("Flyingfp_stalwart");
		local pos,face;
	...
	hook.Add("CalcView", "fp_stalwartView", CalcView)
	...
	hook.Add("HUDPaint", "fp_stalwartReticle", fp_stalwartReticle)
