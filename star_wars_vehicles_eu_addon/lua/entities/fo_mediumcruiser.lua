...
ENT.PrintName = "Medium Cruiser"
ENT.Author = "Liam0102, Servius, Nash, Stefano"
...
ENT.EntModel = "models/sweaw/ships/fo_mediumcruiser.mdl"
ENT.Vehicle = "fo_mediumcruiser"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("fo_mediumcruiser");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fo_mediumcruiser")
		local Flying = p:GetNWBool("Flyingfo_mediumcruiser");
		local pos,face;
		if(IsValid(self)) then
			...
			if(LightSpeed == 2) then
				...
				View =  SWVehicleView(self,-5000,1000,fpvPos);
			end
	...
	hook.Add("CalcView", "fo_mediumcruiserView", CalcView)
	...
	function fo_mediumcruiserReticle()
	...
	hook.Add("HUDPaint", "fo_mediumcruiserReticle", fo_mediumcruiserReticle)
