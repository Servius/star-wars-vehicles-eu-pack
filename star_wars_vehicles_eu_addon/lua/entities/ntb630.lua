...
function ENT:Effects()
    ...
    local function CalcView()      
		...
		local p = LocalPlayer();
		local self = p:GetNetworkedEntity("ntb630", NULL)
    ...
    hook.Add("CalcView", "ntb630view", CalcView) // This is very important. Make sure the middle arguement is unique. In this case the ship name + view
 
	local function ntb630Reticle()
		
		local p = LocalPlayer();
		local Flying = p:GetNWBool("Flyingntb630");
		local self = p:GetNWEntity("ntb630");
    ...
    hook.Add("HUDPaint", "ntb630Reticle", ntb630Reticle) // Here you need to make the middle argument something unique again. I've set it as what the function is called. Could be anything. And the final arguement should be the function just made.
