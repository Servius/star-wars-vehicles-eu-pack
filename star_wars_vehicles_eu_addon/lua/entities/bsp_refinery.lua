...
ENT.EntModel = "models/bsp_refinery/bsp_refinery.mdl"
ENT.Vehicle = "bsp_refinery"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("bsp_refinery");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_refinery")
		local Flying = p:GetNWBool("Flyingbsp_refinery");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_refineryView", CalcView)
	...
	hook.Add("HUDPaint", "bsp_refineryReticle", bsp_refineryReticle)
