...
ENT.EntModel = "models/csp_nebula/csp_nebula.mdl"
ENT.Vehicle = "csp_nebula"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("csp_nebula");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("csp_nebula")
		local Flying = p:GetNWBool("Flyingcsp_nebula");
		local pos,face;
	...
	hook.Add("CalcView", "csp_nebulaView", CalcView)
	...
	hook.Add("HUDPaint", "csp_nebulaReticle", csp_nebulaReticle)
