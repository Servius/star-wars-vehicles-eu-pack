...
ENT.EntModel = "models/ship_provi/ship_provi.mdl"
ENT.Vehicle = "providence"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("providence");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("providence")
		local Flying = p:GetNWBool("Flyingprovidence");
		local pos,face;
		if(IsValid(self)) then
			...
			if(LightSpeed == 2) then
				...
				View =  SWVehicleView(self,-2000,350,fpvPos);
			end
	...
	hook.Add("CalcView", "providenceView", CalcView)
	...
	hook.Add("HUDPaint", "providenceReticle", providenceReticle)
