...
ENT.EntModel = "models/csp_strident/csp_strident.mdl"
ENT.Vehicle = "csp_strident"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("csp_strident");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("csp_strident")
		local Flying = p:GetNWBool("Flyingcsp_strident");
		local pos,face;
	...
	hook.Add("CalcView", "csp_stridentView", CalcView)
	...
	hook.Add("HUDPaint", "csp_stridentReticle", csp_stridentReticle)
