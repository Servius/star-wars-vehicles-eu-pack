...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("csp_mc90")
		local Flying = p:GetNWBool("Flyingcsp_mc90");
		local pos,face;
	...
	hook.Add("CalcView", "csp_mc90View", CalcView)
	...
	hook.Add("HUDPaint", "csp_mc90Reticle", csp_mc90Reticle)
