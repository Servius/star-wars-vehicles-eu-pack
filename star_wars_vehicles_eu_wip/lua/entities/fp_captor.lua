...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fp_captor")
		local Flying = p:GetNWBool("Flyingfp_captor");
		local pos,face;
	...
	hook.Add("CalcView", "fp_captorView", CalcView)
	...
	hook.Add("HUDPaint", "fp_captorReticle", fp_captorReticle)
