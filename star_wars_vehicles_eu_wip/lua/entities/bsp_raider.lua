...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_raider")
		local Flying = p:GetNWBool("Flyingbsp_raider");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_raiderView", CalcView)
	...
	hook.Add("HUDPaint", "bsp_raiderReticle", bsp_raiderReticle)
