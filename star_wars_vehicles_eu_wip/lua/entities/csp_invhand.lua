...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("csp_invhand")
		local Flying = p:GetNWBool("Flyingcsp_invhand");
		local pos,face;
	...
	hook.Add("CalcView", "csp_invhandView", CalcView)
	...
	hook.Add("HUDPaint", "csp_invhandReticle", csp_invhandReticle)
