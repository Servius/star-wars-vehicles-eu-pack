...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fp_cc7700")
		local Flying = p:GetNWBool("Flyingfp_cc7700");
		local pos,face;
	...
	hook.Add("CalcView", "fp_cc7700View", CalcView)
	...
	hook.Add("HUDPaint", "fp_cc7700Reticle", fp_cc7700Reticle)
