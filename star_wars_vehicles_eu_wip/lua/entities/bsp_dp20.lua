...
ENT.EntModel = "models/bsp_dp20/bsp_dp20.mdl"
ENT.Vehicle = "bsp_dp20"
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_dp20")
		local Flying = p:GetNWBool("Flyingbsp_dp20");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_dp20View", CalcView)
	...
	hook.Add("HUDPaint", "bsp_dp20Reticle", bsp_dp20Reticle)
