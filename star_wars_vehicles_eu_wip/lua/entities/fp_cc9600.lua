...
ENT.EntModel = "models/fp_cc9600/fp_cc9600.mdl"
ENT.Vehicle = "fp_cc9600"
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fp_cc9600")
		local Flying = p:GetNWBool("Flyingfp_cc9600");
		local pos,face;
	...
	hook.Add("CalcView", "fp_cc9600View", CalcView)
	...
	hook.Add("HUDPaint", "fp_cc9600Reticle", fp_cc9600Reticle)
