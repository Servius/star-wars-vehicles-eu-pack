...
ENT.EntModel = "models/csp_viscount/csp_viscount.mdl"
ENT.Vehicle = "csp_viscount"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("csp_viscount");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("csp_viscount")
		local Flying = p:GetNWBool("Flyingcsp_viscount");
		local pos,face;
	...
	hook.Add("CalcView", "csp_viscountView", CalcView)
	...
	hook.Add("HUDPaint", "csp_viscountReticle", csp_viscountReticle)
