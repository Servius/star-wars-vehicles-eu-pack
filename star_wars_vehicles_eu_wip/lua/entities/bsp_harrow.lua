...
ENT.EntModel = "models/bsp_harrow/bsp_harrow.mdl"
ENT.Vehicle = "bsp_harrow"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("bsp_harrow");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_harrow")
		local Flying = p:GetNWBool("Flyingbsp_harrow");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_harrowView", CalcView)
	...
	hook.Add("HUDPaint", "bsp_harrowReticle", bsp_harrowReticle)
