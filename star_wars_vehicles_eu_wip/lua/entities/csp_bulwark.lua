...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("csp_bulwark")
		local Flying = p:GetNWBool("Flyingcsp_bulwark");
		local pos,face;
	...
	hook.Add("CalcView", "csp_bulwarkView", CalcView)
	...
	hook.Add("HUDPaint", "csp_bulwarkReticle", csp_bulwarkReticle)
