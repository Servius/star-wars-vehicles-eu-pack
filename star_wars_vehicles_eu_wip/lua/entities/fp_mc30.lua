...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("fp_mc30")
		local Flying = p:GetNWBool("Flyingfp_mc30");
		local pos,face;
	...
	hook.Add("CalcView", "fp_mc30View", CalcView)
	...
	hook.Add("HUDPaint", "fp_mc30Reticle", fp_mc30Reticle)
